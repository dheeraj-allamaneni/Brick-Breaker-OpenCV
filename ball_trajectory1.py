...
cap = cv2.VideoCapture('L5_clip2_12s.mp4')

script_dir = os.path.dirname(__file__)
mat = scipy.io.loadmat('video2_12sec_centroid_1c.mat')
new_data = mat['whiteBlob_matrix']

fourcc = cv2.VideoWriter_fourcc(*'X264')
out = cv2.VideoWriter('1c0_output.mp4',fourcc, 60.0, (int(cap.get(3)),int(cap.get(4))),isColor=1)
